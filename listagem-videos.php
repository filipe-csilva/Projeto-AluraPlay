<?php
    ...
    $dadosVideos = $videoRepositorio->buscarTodos();
...
<body>
    <header>
        ...
        <nav class="cabecalho">
            ...
            <div class="cabecalho__icones">
                <a href="./pages/novo-video" class="cabecalho__videos"></a>
    ...
    <ul class="videos__container" alt="videos alura">
        <?php foreach($dadosVideos as $video):?>
                ...
                <li class="videos__item">
                    ...
                    <div class="descricao-video">
                        ...
                        <div class="acoes-video">
                            <a href="./pages/editar-video.php?id=<?= $video->getId() ?>">Editar</a>
